...
//       image: classImage,
//       instructor: {
//         name: "John Doe", // Replace with the logged-in instructor's name
//         email: "johndoe@example.com", // Replace with the logged-in instructor's email
//       },
//       availableSeats,
//       price,
//       status: "pending",
...
//   const handleUpdateFeedback = (className, feedback) => {
...
//       {/* Add a Class */}
//       <div className="mb-8">
//         <h3 className="text-lg font-semibold mb-4">Add a Class</h3>
...
//           </div>
//           <div className="mb-4">
//             <label className="block mb-2">Class Image</label>
//             <input
//               type="text"
//               className="border border-gray-300 px-4 py-2 w-full"
//               value={classImage}
...
//                       <button
//                         onClick={() =>
//                           handleUpdateFeedback(cls.name, "Class denied")
//                         }
//                         className="mr-2">
//                         Deny
//                       </button>
...
//                     {cls.status === "approved" && (
//                       <button
//                         onClick={() => handleUpdateFeedback(cls.name, "")}
//                         className="mr-2">
//                         Clear Feedback
//                       </button>
//                     )}
...
//     return (
//       <div>
//         <div className="flex flex-col h-[100vh] p-3 w-60 dark:bg-gray-900 dark:text-gray-100">
